...
public class TrafficSignal {
    ...
    */
    ...
    public void TrafficLight(char direction, int greenDuration, int yellowDuration, int redDuration) {
	...
	*/
        ...
        this.currentState = 1; // 初始狀態為紅燈 o:"red"
    }
...
//        performSignal();
    ...
    public void transitionToNextState() {
        switch (currentState) {
            case 3:
                currentState = 2; // o: "yellow"
                break;
            case 2:
                currentState = 1; // o: "red"
                break;
            case 1:
                currentState = 3; // o:"green"
                break;
        }
